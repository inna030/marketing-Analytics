...
confusionMatrix(table(1*(data$churn_prob<0.2),1*(data$Churn=='Yes')))
```
...
```{r}
sum(data$churn_prob<0.20) # number of customers with probability of churn strictly greater than 60%
```
